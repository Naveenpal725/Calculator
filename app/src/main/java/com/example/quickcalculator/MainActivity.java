...
//        solutionTv.setText(buttonText);
        String ToCalculate =solutionTv.getText().toString();
        ...
        solutionTv.setText(ToCalculate);
    ...
    String getResult(String data) {
        try {
            ...
            String totalValue = context.evaluateString(scriptable, data, "Javascript", 1, null).toString();
            if (totalValue.endsWith(".0")) {
